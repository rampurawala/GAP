...
public class RecyclerImageAdapter extends RecyclerView.Adapter<RecyclerImageAdapter.ItemViewHolder> {
    ...
    public RecyclerImageAdapter(ArrayList<ImageVideoGtSt> mArrayUri, Context context) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, final int position) {
        ...
        Picasso.with((context)).load(list.getImg()).placeholder(R.mipmap.ic_launcher).into(holder.img);
